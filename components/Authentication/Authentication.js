...
export default class Authentication extends Component {
    ...
    render() {
        ...
        const mainJSX = isSignIn ? <SignIn onPress = {() =>navigate('Main')} /> : <SignUp gotoSignIn={this.gotoSignIn.bind(this)} />;
        return (
            <View style={container}>
                <View style={row1}>
                    <TouchableOpacity onPress={()=>navigate('Main')}>
                        <Image source={require('../../Images/back_white.png')} style={iconStyle} />
                    </TouchableOpacity>
                    <Text style={titleStyle}>Wearing a Dress</Text>
                    <Image source={require('../../Images/react.png')} style={iconStyle} />
                </View>
                {mainJSX}
